                    ...
                    <div class="col-8">
                        <div class="numbers"> 
                            ...
                            <h5 class="font-weight-bolder mb-0">                                
                                {{ collect($data)->where('status', 'Approve')->count() }}
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Demand</p>
                            <h5 class="font-weight-bolder mb-0">
                            {{ collect($data)->where('status', 'Demand')->count() }}
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">On - Process</p>
                            <h5 class="font-weight-bolder mb-0">
                            {{ collect($data)->where('status', 'On-Process')->count() }}
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">H - 3 Day</p>
                            <h5 class="font-weight-bolder mb-0">
                                10
