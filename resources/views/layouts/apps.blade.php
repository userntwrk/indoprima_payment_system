...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('assets/img/company_logo.png')}}">    
    

    <title>
        Indoprima Payment System
    </title>
...
<body class="g-sidenav-show  bg-gray-100  ">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="/main">
                <img src="{{asset('assets/img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="...">
                <span class="ms-3 font-weight-bold">Indoprima Payment System</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/validate">
                        ...
                        <span class="nav-link-text ms-1">Validation & Due Date</span>
                    </a>
                </li>
                <!-- <li class="nav-item pb-2">
                    <a class="nav-link" href="/due_date">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">                            
                            <i style="font-size: 1rem;" class="fas fa-lg fa-calendar-alt ps-2 pe-2 text-center text-dark text-dark" aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1">Due Date</span>
                    </a>
                </li>                 -->
            </ul>
        </div>        
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://www.indoprimagemilang.com" class="font-weight-bold" target="_blank">PT
                                    INDOPRIMA GEMILANG</a>
                            </div>
                        </div>
                        <!-- <div class="col-lg-6">
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"7ed18a9e4b943f66","version":"2023.7.0","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
    ...
    <script>        
        $(document).ready(function() {
            ...
            // for treeview
            $('ul.navbar-nav .treeview-menu a').filter(function() {
                return this.href == url;
            ...
            $('ul.navbar-nav .treeview-menu a').filter(function() {
                return this.href == url;
            }).parentsUntil(".navbar-nav > .treeview-menu").addClass('menu-open');
        });
    </script>    
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.datepicker').change(function() {
                ...
                // status should be "Approved" when a due date is selected
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        // Update the table cell with the new due date and status
                        $("#stat_" + suratTagihan + "").text(newStatus).addClass('badge bg-gradient-success');
                        alert("Due Date & Status Has Been Update");
                    },
                    error: function(error) {
                        alert('An error occurred while updating the due date and status');
